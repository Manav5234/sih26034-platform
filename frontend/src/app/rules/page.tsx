...
async function getRules(token: string, effectiveDate?: string): Promise<RuleSet | null> {
...
export default async function RulesPage({
  ...
  searchParams: Promise<{ effective_date?: string }>;
}) {
  ...
  const data = await getRules(token, params.effective_date);
